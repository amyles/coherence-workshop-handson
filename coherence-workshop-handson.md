...
The output will list the addresses under EXTERNAL-IP column, copy any one and enter the URL changing EXTERNAL_IP for a proper address: http://EXTERNAL-IP:32636/application/index.html This will open the UI:
